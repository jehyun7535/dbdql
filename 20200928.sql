START WITH : 계층쿼리의 시작 점(행), 여러개의 행을 조회하는 조건이 들어갈 수 도 있다
...
insert into board_test values (1, '첫번쨰', '첫번째 글입니다');
...
CONNECT BY PRIOR seq = parent_seq); --6
ORDER SIBLINGS BY seq DESC, seq ASC; --7
...
순위관련 분석함수 - 동일 값에 대한 순윛리에 따라 3가지 함수를 제공
